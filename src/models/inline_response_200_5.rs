...
impl InlineResponse2005 {
  pub fn new(success: bool, ticker: String, ) -> InlineResponse2005 {
    InlineResponse2005 {
      results_count: None,
      db_latency: None,
      success: success,
  ...
  pub fn with_results_count(mut self, results_count: i64) -> InlineResponse2005 {
    self.results_count = Some(results_count);
    self
  }
  ...
  pub fn with_db_latency(mut self, db_latency: i64) -> InlineResponse2005 {
    self.db_latency = Some(db_latency);
    self
  }
  ...
  pub fn with_success(mut self, success: bool) -> InlineResponse2005 {
    self.success = success;
    self
  }
  ...
  pub fn with_ticker(mut self, ticker: String) -> InlineResponse2005 {
    self.ticker = ticker;
    self
  }
  ...
  pub fn with_results(mut self, results: Vec<StocksV2Trade>) -> InlineResponse2005 {
    self.results = Some(results);
    self
  }
